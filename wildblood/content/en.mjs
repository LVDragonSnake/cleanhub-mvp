...
export default {
  ...
  archive: {
    ...
    viewer: { download: 'Download PDF', preview: 'Preview only', files: 'downloadable', doc: 'Document', open: 'Open file', count: 'documents', empty: 'No declassified documents in this section.', close: 'Close', prev: 'Previous', next: 'Next', of: 'of', zoom: 'Zoom' },
    locked: 'Locked', open: 'Open file',
    items: [
      { key: 'arcDossier', docs: [{c:'ARG-N01',t:'Subject record — Nereus-3',k:'docN01',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_33275dcbcc4247058af37035b5ceecf2.pdf',size:'0,9 MB'}, {c:'ARG-A17',t:'Artifact dossier — China sector',k:'docA17',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_a2e5b56353be49c9a5e5395db7e7b4d5.pdf',size:'0,8 MB'}, {c:'ARG-INT07',t:'Interrogation transcript (redacted)',k:'docINT07'}, {c:'ARG-INT07',t:'Interrogation — case file',k:'docINT07D'}],    code: 'ARG-DSR', name: 'ARGOS Dossier',    desc: 'Subject records, surveillance profiles and risk assessments on identified hybrids.' },
      { key: 'arcClassified', docs: [{c:'ARG-CLF12',t:'Operation Nightfall — Site 07',k:'docCLF12'}, {c:'ARG-MAIL02',t:'Containment directive — Nereus-3',k:'docMAIL02',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_992ec4d5445d4996b759aee9d2e4d27a.pdf',size:'2,7 MB'}, {c:'ARG-MAIL06',t:'Protocol anomaly log',k:'docMAIL06',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_ba57c33954b845a0b5b3452f921b3db2.pdf',size:'3,0 MB'}, {c:'ARG-MAIL17',t:'Alert — containment failure',k:'docMAIL17',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_2146c814395b452ab3ee56415de52c94.pdf',size:'3,1 MB'}], code: 'ARG-CLF', name: 'Classified Files', desc: 'Limited-distribution documents. Unacknowledged operations, redacted sites, erased names.' },
      { key: 'arcField', docs: [{c:'ARG-FL09',t:'Cavern expedition — Delta-6',k:'docFL09'}, {c:'ARG-FL09',t:'Delta-6 — case file',k:'docFL09D'}, {c:'ARG-FL12',t:'Subglacial structure — Antarctic shelf',k:'docFL12'}, {c:'ARG-FL12',t:'Antarctic — case file',k:'docFL12D'}, {c:'ARG-FL14',t:'Forest entity tracking — Chugach sector',k:'docFL14'}, {c:'ARG-FL14',t:'Chugach — case file',k:'docFL14D'}, {c:'ARG-FL18',t:'Artifact recovery — Karakorum Delta-6',k:'docFL18'}, {c:'ARG-FL18',t:'Karakorum — case file',k:'docFL18D'}],      code: 'ARG-FL',  name: 'Field Logs',       desc: 'Readings from the field: cavern expeditions, subglacial structures, artifact recoveries.' },
      { key: 'arcIncident', docs: [{c:'ARG-IR03',t:'Incident report — Maldives sector',k:'docIR03',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_445a19dde4cd4cbc9e3d541b60ef0e51.pdf',size:'0,8 MB'}, {c:'ARG-IR07',t:'Unidentified survivor — Socotra sector',k:'docIR07',pdf:'https://6f0ea2c5-da9b-4566-886c-8701cb2e582f.usrfiles.com/ugd/82d24b_2a51e9e8b7c743c1813815756846eb27.pdf',size:'13,4 MB'}, {c:'ARG-IR12',t:'Reopened casefile — Karakorum sector',k:'docIR12'}],   code: 'ARG-IR',  name: 'Incident Reports', desc: 'What went wrong. Failed containments, unidentified survivors, compromised sectors.' },
      { key: 'arcVisual', docs: [{c:'ARG-NET02',t:'Global anomaly monitoring grid',k:'docNET02'}, {c:'ARG-SAT01',t:'Anomalous activity detected — satellite',k:'docSAT01'}, {c:'ARG-SYS03',t:'Unauthorized access detected',k:'docSYS03'}],     code: 'ARG-VR',  name: 'Visual Records',   desc: 'Satellite imagery, surveillance stills, recovered visual material.' },
      { key: 'arcAuthor', docs: [],     code: 'AUT-ARC', name: 'Author Archive',   desc: 'Author’s notes, worldbuilding material and behind-the-scenes of the saga.' },
    ],
  },
