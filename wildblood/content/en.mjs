...
export default {
  ...
  archive: {
    ...
    viewer: { open: 'Open file', count: 'documents', empty: 'No declassified documents in this section.', close: 'Close', prev: 'Previous', next: 'Next', of: 'of', zoom: 'Zoom' },
    locked: 'Locked', open: 'Open file',
    items: [
      { key: 'arcDossier', docs: [{c:'ARG-N01',t:'Subject record — Nereus-3',k:'docN01'}, {c:'ARG-A17',t:'Artifact dossier — China sector',k:'docA17'}, {c:'ARG-INT07',t:'Interrogation transcript (redacted)',k:'docINT07'}, {c:'ARG-INT07',t:'Interrogation — case file',k:'docINT07D'}],    code: 'ARG-DSR', name: 'ARGOS Dossier',    desc: 'Subject records, surveillance profiles and risk assessments on identified hybrids.' },
      { key: 'arcClassified', docs: [{c:'ARG-CLF12',t:'Operation Nightfall — Site 07',k:'docCLF12'}, {c:'ARG-MAIL02',t:'Containment directive — Nereus-3',k:'docMAIL02'}, {c:'ARG-MAIL06',t:'Protocol anomaly log',k:'docMAIL06'}, {c:'ARG-MAIL17',t:'Alert — containment failure',k:'docMAIL17'}], code: 'ARG-CLF', name: 'Classified Files', desc: 'Limited-distribution documents. Unacknowledged operations, redacted sites, erased names.' },
      ...
      { key: 'arcIncident', docs: [{c:'ARG-IR03',t:'Incident report — Maldives sector',k:'docIR03'}, {c:'ARG-IR07',t:'Unidentified survivor — Socotra sector',k:'docIR07'}, {c:'ARG-IR12',t:'Reopened casefile — Karakorum sector',k:'docIR12'}],   code: 'ARG-IR',  name: 'Incident Reports', desc: 'What went wrong. Failed containments, unidentified survivors, compromised sectors.' },
